...
function atualizarCardsUltimos30Dias() {
  ...
  // Diminuir fonte se total for grande
if (total.toFixed(0).length > 5) {
  let diminuirH3 = document.querySelector(".h3_diminuir");
  if (diminuirH3) {
    diminuirH3.style.fontSize = "40px";
  }
  document.querySelectorAll(".valor_total_ok").forEach((el) => {
...
// Diminuir fonte se lucro for grande
if (lucro.toFixed(0).length > 5) {
  let diminuirH3 = document.querySelector(".h3Menor");
  if (diminuirH3) {
    diminuirH3.style.fontSize = "40px";
  }
  document.querySelectorAll(".valor_lucro_ok").forEach((el) => {
    el.style.fontSize = "40px";
  });
} else {
  document.querySelectorAll(".valor_lucro_ok").forEach((el) => {
